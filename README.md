...
Amestecare aleatorie a datelor de antrenament
Împărțire în mini-batch-uri de 64 de exemple
Pentru fiecare mini-batch:
...
Setul de antrenament (1000 de exemple) a fost împărțit în 10 subseturi egale de câte 100 de exemple
La fiecare iterație (fold), 9 subseturi (900 exemple) au fost folosite pentru antrenament, iar 1 subset (100 exemple) pentru validare
Procesul s-a repetat de 10 ori, fiecare subset servind o dată ca set de validare
S-au calculat acuratețea medie și intervalul de încredere de 90%
2.2 Rezultatele validării încrucișate
Rulați python crossval.py și înlocuiți valorile de mai jos cu cele din cv_results.txt.
...
Fold 9	___
Fold 10	___
2.3 Acuratețea medie ��i intervalul de încredere 90%
Metrică	Valoare
Acuratețe medie	___
Deviație standard	___
Interval de încredere 90%	[ ___ , ___ ]
...
Liniile reprezintă clasa reală (T1–T10), coloanele reprezintă clasa prezisă (P1–P10). Valorile de pe diagonală reprezintă predicțiile corecte.
...
T9  [                                         ]
T10 [                                         ]
(Repetați formatul de mai sus pentru Fold 2 – Fold 10 după rularea crossval.py)
